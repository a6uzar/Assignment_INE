...
export function SocialSharing({
    ...
    const toggleLike = async () => {
        if (!user) {
            toast({
                ...
                description: "You need to be signed in to like auctions",
                variant: "destructive",
            });
            return;
        }
            ...
            if (isLiked) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        toast({
                            title: "Removed like",
                            description: "You've removed your like from this auction.",
                        });
                        return;
                    }
                } catch (dbError) {
                    console.log('Database table not available, using local state');
                }
                ...
                toast({
                    title: "Removed like",
                    description: "You've removed your like from this auction (local only).",
                });
            } else {
                // Add like
                try {
                    ...
                    if (!error) {
                        ...
                        toast({
                            title: "Liked auction",
                            description: "You've liked this auction!",
                        });
                        return;
                    }
                } catch (dbError) {
                ...
                toast({
                    title: "Liked auction",
                    description: "You've liked this auction (local only)!",
                });
            }
        } catch (error) {
    ...
    const toggleBookmark = async () => {
        if (!user) {
            toast({
                title: "Please sign in",
                description: "You need to be signed in to bookmark auctions",
                variant: "destructive",
            });
            return;
        }
        ...
        try {
            if (isBookmarked) {
                ...
                toast({
                    title: "Bookmark removed",
                    description: "Removed from your bookmarks (local only)",
                    duration: 2000,
                });
            } else {
                // Add bookmark
                ...
                toast({
                    title: "Bookmark added",
                    description: "Added to your bookmarks (local only)",
                    duration: 2000,
                });
            }
        } catch (error) {
    ...
    const toggleFollowSeller = async () => {
        ...
        if (user.id === auction.seller_id) {
            toast({
                ...
                description: "You cannot follow your own auction",
                variant: "destructive",
            });
            return;
        }
            ...
            if (isFollowingSeller) {
                ...
                try {
                    const { error } = await supabase
                        ...
                        .eq('following_id', auction.seller_id);
                    ...
                    if (!error) {
                        ...
                        toast({
                            title: "Unfollowed",
                            description: "No longer following this seller",
                            duration: 2000,
                        });
                        return;
                    }
                ...
                toast({
                    title: "Unfollowed",
                    description: "No longer following this seller (local only)",
                    duration: 2000,
                });
            } else {
                // Follow seller
                try {
                    ...
                    if (!error) {
                        ...
                        toast({
                            title: "Following",
                            description: "You're now following this seller",
                            duration: 2000,
                        });
                        return;
                    }
                ...
                toast({
                    title: "Following",
                    description: "You're now following this seller (local only)",
                    duration: 2000,
                });
            }
        } catch (error) {
