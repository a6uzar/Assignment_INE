    ...
    const fetchNotifications = async () => {
        ...
        try {
            ...
            try {
                ...
                if (notificationsData && notificationsData.length >= 0) {
                    ...
                    const transformedNotifications: Notification[] = notificationsData.map(notification => ({
                        ...
                        auction: notification.auction ? {
                            ...
                            current_price: notification.auction.current_price
                        } : undefined
                    }));
                ...
                console.log('Database table not available or empty, using mock data');
            }
            ...
            const mockData: Notification[] = [
                ...
                },
                {
                    ...
                    message: '"Rare Art Piece" is ending in 15 minutes. Place your final bid!',
                    data: { auctionTitle: 'Rare Art Piece', minutesLeft: 15 },
                    is_read: false,
                    is_email_sent: true,
                ...
                },
                {
                    ...
                    message: 'Someone outbid you on "Antique Furniture Set". Current bid: $3,200',
                    data: { auctionTitle: 'Antique Furniture Set', newBid: 3200 },
                    is_read: true,
                    is_email_sent: true,
