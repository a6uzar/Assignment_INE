  ...
  public: {
    Tables: {
      ...
      auction_bookmarks: {
        ...
        Relationships: [
          {
            foreignKeyName: "auction_bookmarks_auction_id_fkey"
            columns: ["auction_id"]
            isOneToOne: false
            referencedRelation: "auctions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "auction_bookmarks_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      auction_chat: {
        ...
        Relationships: [
          {
            foreignKeyName: "auction_chat_auction_id_fkey"
            columns: ["auction_id"]
            isOneToOne: false
            referencedRelation: "auctions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "auction_chat_reply_to_id_fkey"
            columns: ["reply_to_id"]
            isOneToOne: false
            referencedRelation: "auction_chat"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "auction_chat_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      auction_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "auction_likes_auction_id_fkey"
            columns: ["auction_id"]
            isOneToOne: false
            referencedRelation: "auctions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "auction_likes_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      auction_reactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "auction_reactions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
